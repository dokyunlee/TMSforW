...
이 작업은 본인의 페이스에 맞춰 편안하게 진행하시면 됩니다. 각 이미지를 보고 가장 적합하다고 생각되는 단어를 선택해 주세요.

작업자님의 판단은 데이터의 품질을 높이는 데 중요한 역할을 합니다. 너무 오래 고민하기보다는 이미지를 보고 가장 자연스럽게 떠오르는 선택을 해주시면 충분합니다.

소중한 시간을 내어 참여해 주셔서 감사합니다. 여러분의 참여는 더 나은 AI 시스템을 만드는 데 큰 도움이 됩니다.`,
      afterText: "물건 분류 테스트가 완료되었습니다. 제출한 응답과 진행 기록이 검증용 결과로 저장되었습니다. 참여해 주셔서 감사합니다.",
